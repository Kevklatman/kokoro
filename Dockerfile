...
RUN echo '#!/bin/bash' > /app/start.sh \
  ...
  && echo 'echo "MODELS_DIR: $MODELS_DIR"' >> /app/start.sh \
  && echo 'echo "PWD: $(pwd)"' >> /app/start.sh \
  && echo 'echo "ls -la /app/models:"' >> /app/start.sh \
  && echo 'ls -la /app/models' >> /app/start.sh \
  && echo 'echo "ls -la /app/models/voices:"' >> /app/start.sh \
  && echo 'ls -la /app/models/voices' >> /app/start.sh \
  && echo '' >> /app/start.sh \
